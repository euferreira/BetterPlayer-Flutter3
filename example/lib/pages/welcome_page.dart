...
import 'package:better_player_awesome_example/pages/auto_fullscreen_orientation_page.dart';
import 'package:better_player_awesome_example/pages/basic_player_page.dart';
import 'package:better_player_awesome_example/pages/cache_page.dart';
import 'package:better_player_awesome_example/pages/clearkey_page.dart';
import 'package:better_player_awesome_example/pages/controller_controls_page.dart';
import 'package:better_player_awesome_example/pages/controls_always_visible_page.dart';
import 'package:better_player_awesome_example/pages/controls_configuration_page.dart';
import 'package:better_player_awesome_example/pages/custom_controls/change_player_theme_page.dart';
import 'package:better_player_awesome_example/pages/dash_page.dart';
import 'package:better_player_awesome_example/pages/drm_page.dart';
import 'package:better_player_awesome_example/pages/event_listener_page.dart';
import 'package:better_player_awesome_example/pages/fade_placeholder_page.dart';
import 'package:better_player_awesome_example/pages/hls_audio_page.dart';
import 'package:better_player_awesome_example/pages/hls_subtitles_page.dart';
import 'package:better_player_awesome_example/pages/hls_tracks_page.dart';
import 'package:better_player_awesome_example/pages/memory_player_page.dart';
import 'package:better_player_awesome_example/pages/normal_player_page.dart';
import 'package:better_player_awesome_example/pages/notification_player_page.dart';
import 'package:better_player_awesome_example/pages/overridden_aspect_ratio_page.dart';
import 'package:better_player_awesome_example/pages/overriden_duration_page.dart';
import 'package:better_player_awesome_example/pages/placeholder_until_play_page.dart';
import 'package:better_player_awesome_example/pages/playlist_page.dart';
import 'package:better_player_awesome_example/pages/resolutions_page.dart';
import 'package:better_player_awesome_example/pages/reusable_video_list/reusable_video_list_page.dart';
import 'package:better_player_awesome_example/pages/rotation_and_fit_page.dart';
import 'package:better_player_awesome_example/pages/subtitles_page.dart';
import 'package:better_player_awesome_example/pages/video_list/video_list_page.dart';
import 'package:better_player_awesome_example/pages/picture_in_picture_page.dart';
