package com.example.better_player_awesome
...
import com.example.better_player_awesome.BetterPlayerCache.releaseCache
...
/** BetterPlayerAwesomePlugin */
class BetterPlayerAwesomePlugin: FlutterPlugin, ActivityAware, MethodCallHandler {
  ...
  private fun startPictureInPictureListenerTimer(player: BetterPlayer) {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
      pipHandler = android.os.Handler(Looper.getMainLooper())
  ...
  private class FlutterState(
    ...
    fun startListening(methodCallHandler: BetterPlayerAwesomePlugin?) {
